...
<head>
    ...
    <meta charset="UTF-8">
    <title>Twitter Clone by getidea.net</title>
                    ...
                    <div class="flex">
                        ...
                        @if(auth()->id() !=$user->id)
                            @if(count($user_follow)>0)
                                <a style="text-align: center; width: 250px;"  href="{{route('unfollow',$user->id)}}" class="p-3 twitter-bg text-white w-full rounded-full font-bold tracking-wide">Takibi Bırak</a>
                                        ...
                                        <div class="tweet-tweet">
                                            ...
                                            <div class="tweet-info-bar flex items-center ">
                                                ...
                                                <span class="tweet-username relative block">
                                                    <a href="#" class="hover:underline text-gray-900 font-bold text-base mr-1">{{$tweet->users->name}}</a>
                                            ...
                                            <div class="tweet-footer">
                                                <div class="inner flex">
                                                    ...
                                                    <div class="inline-block w-full">
                                                        <a href="{{route('fav_tweet',$tweet->id)}}">
